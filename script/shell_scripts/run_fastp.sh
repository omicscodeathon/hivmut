...
process_reads() {
    local fwd_file="$1"
    local base="$(basename "${fwd_file}" _1.fastq)"
    local rev_file="${READS_DIR}/${base}_2.fastq"
...
for fwd_file in "$READS_DIR"/*_1.fastq; do
